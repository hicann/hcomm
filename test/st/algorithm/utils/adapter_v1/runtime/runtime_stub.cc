...
aclError aclsysGetVersionStr(char* pkgName, char* versionStr) { return RT_ERROR_NONE; }
...
HcclResult hrtCacheLastTaskExtendInfo(const char* tag, size_t tagLen) { return HCCL_E_NOT_SUPPORT; }
