...
class RunBroadCastMeshExecutorA2Test :
    public ::testing::TestWithParam<
        std::tuple<uint64_t, CheckerDataType, vector<int>, CheckerOpMode, CheckerDevType, std::string, int>> {
public:
    static void SetUpTestCase() { std::cout << "RunBroadCastMeshExecutorA2Test set up." << std::endl; }

    static void TearDownTestCase() { std::cout << "RunBroadCastMeshExecutorA2Test tear down." << std::endl; }
...
TEST_P(RunBroadCastMeshExecutorA2Test, Test_BroadCastMesh_A2)
{
    ...
    std::cout << "--- dataSize=" << dataSize << ", dataType=" << dataType << ", opMode=" << opMode << ", topo={"
              << topo[0] << ", " << topo[1] << ", " << topo[2] << "}" << ", hcclAlgo=" << hcclAlgo
              << ", root = " << root << std::endl;
...
INSTANTIATE_TEST_SUITE_P(
    BroadCastMeshExecutor_A2, RunBroadCastMeshExecutorA2Test,
    testing::Combine(
        ...
        testing::Values("NB"), testing::Values(0, 1, 2, 3)));

class RunBroadCastMeshExecutorAlgoTest :
    public ::testing::TestWithParam<
        std::tuple<uint64_t, CheckerDataType, vector<int>, CheckerOpMode, CheckerDevType, std::string, bool>> {
public:
    static void SetUpTestCase() { std::cout << "RunBroadCastMeshExecutorAlgoTest set up." << std::endl; }

    static void TearDownTestCase() { std::cout << "RunBroadCastMeshExecutorAlgoTest tear down." << std::endl; }
...
INSTANTIATE_TEST_SUITE_P(
    BroadCastMeshExecutor_Algo_A2, RunBroadCastMeshExecutorAlgoTest,
    testing::Combine(
