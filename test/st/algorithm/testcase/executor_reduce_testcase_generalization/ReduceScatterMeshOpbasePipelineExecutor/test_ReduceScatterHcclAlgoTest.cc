...
protected:
    static void SetUpTestCase() { std::cout << "ReduceScatterGeneralizationHcclAlgoTest set up." << std::endl; }

    static void TearDownTestCase() { std::cout << "ReduceScatterGeneralizationHcclAlgoTest tear down." << std::endl; }
