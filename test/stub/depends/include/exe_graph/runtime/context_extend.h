...
public:
     ...
     * @return kernel name
     */
    const ge::char_t* GetKernelName() const { return kernel_name_; }
    /**
     * 设置kernel name
     * @param kernel_name kernel name
     */
    void SetKernelName(const ge::char_t* kernel_name) { kernel_name_ = kernel_name; }
    /**
     * 获取kernel type
     * @return kernel type
     */
    const ge::char_t* GetKernelType() const { return kernel_type_; }
    /**
     * 设置kernel type
