...
public:
    ...
    static bool IsOnHost(TensorPlacement placement) { return (placement == kOnHost) || (placement == kFollowing); }
    static bool IsOnHostFollowing(TensorPlacement placement) { return (placement == kFollowing); }
    static bool IsOnHostNotFollowing(TensorPlacement placement) { return (placement == kOnHost); }
    static bool IsOnDeviceHbm(TensorPlacement placement) { return (placement == kOnDeviceHbm); }
    static bool IsOnDeviceP2p(TensorPlacement placement) { return (placement == kOnDeviceP2p); }
};
...
public:
    ...
    ~TensorData() noexcept { static_cast<void>(Free()); }
     ...
     */
    TensorPlacement GetPlacement() const { return placement_; }
    /**
     * 设置tensor的placement
     * @param tensor的placement
     */
    void SetPlacement(const TensorPlacement placement) { placement_ = placement; }
    /**
     * 释放tensor
    ...
    {
        return (
            addr_ == other.addr_ && manager_ == other.manager_ && size_ == other.size_
            && placement_ == other.placement_);
    }
