...
public:
     ...
     * @return 本kernel的扩展信息
     */
    const KernelExtendInfo* GetExtendInfo() const { return static_cast<const KernelExtendInfo*>(GetKernelExtend()); }
...
static_assert(
    std::is_standard_layout<ExtendedKernelContext>::value, "The class ExtendedKernelRunContext must be a POD");
} // namespace gert
