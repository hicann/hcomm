...
public:
     ...
     */
    const Range<Shape>* GetInputShapeRange(const size_t index) const { return GetInputPointer<Range<Shape>>(index); }
     ...
     */
    const TensorRange* GetInputTensorRange(const size_t index) const { return GetInputPointer<TensorRange>(index); }
     ...
     */
    Range<Shape>* GetOutputShapeRange(const size_t index) { return GetOutputPointer<Range<Shape>>(index); }
};
