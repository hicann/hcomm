...
public:
    ...
    Tensor(
        const StorageShape& storage_shape, const StorageFormat& storage_format, const TensorPlacement placement,
     ...
     * @return shape size
     */
    int64_t GetShapeSize() const { return storage_shape_.GetStorageShape().GetShapeSize(); }
    /**
     * 获取Tensor的数据地址
     * @tparam T 数据类型
     * @return 数据地址
     ...
     * @param data 数据
     */
    void SetData(TensorData&& data) { tensor_data_ = std::move(data); }
    /**
     * 获取Tensor的数据地址
     * @return 数据地址
     */
     ...
     * @return 内存大小
     */
    size_t GetSize() const { return tensor_data_.GetSize(); }

    /**
     * 设置Tensor的内存大小
     * @param Tensor的内存大小
     */
    void SetSize(const size_t size) { tensor_data_.SetSize(size); }
    ...
    CreateFollowing(const int64_t shape_size, const ge::DataType dt, size_t& total_size)
    {
     ...
     */
    static std::unique_ptr<uint8_t[]>
    CreateFollowing(const ge::DataType dt, const size_t tensor_size, size_t& total_size)
    {
     ...
     */
    const Shape& GetStorageShape() const { return storage_shape_.GetStorageShape(); }
    /**
     * 获取运行shape
     * @return 运行时shape的引用
     */
    Shape& MutableStorageShape() { return storage_shape_.MutableStorageShape(); }
    /**
     * 获取原始shape
     * @return 只读的原始shape引用
     */
    const Shape& GetOriginShape() const { return storage_shape_.GetOriginShape(); }
    /**
     * 获取原始shape
     * @return 原始shape引用
     */
    Shape& MutableOriginShape() { return storage_shape_.MutableOriginShape(); }
    /**
     ...
     * @return shape引用
     */
    StorageShape& GetShape() { return storage_shape_; }
    /**
     * 获取运行时format
     * @return 运行时format
     */
     ...
     */
    void SetStorageFormat(const ge::Format storage_format) { storage_format_.SetStorageFormat(storage_format); }
    /**
     * 获取原始format
     * @return 原始format
     */
     ...
     */
    void SetOriginFormat(const ge::Format origin_format) { storage_format_.SetOriginFormat(origin_format); }
    /**
     ...
     * @return format引用
     */
    StorageFormat& MutableFormat() { return storage_format_; }
    /**
     * 获取补维规则
     * @return 补维规则
     */
     ...
     */
    TensorPlacement GetPlacement() const { return tensor_data_.GetPlacement(); }
    /**
     * 设置tensor的placement
     * @param tensor的placement
     */
    void SetPlacement(const TensorPlacement placement) { tensor_data_.SetPlacement(placement); }
    /**
     * 获取tensor data
     ...
     */
    TensorData& MutableTensorData() { return tensor_data_; }
