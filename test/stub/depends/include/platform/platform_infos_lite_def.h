...
/* ==============================AICoreMemoryRates================================ */
enum class AICoreMemoryRatesKey { DDR_RATE = 0, AI_CORE_MEMORY_RATES_KEY_END };
...
/* ============================AICoreSpecKey====================================== */
enum class AICoreSpecKey { UBBLOCK_SIZE = 0, AI_CORE_SPEC_KEY_END };
...
/* ============================CPUCacheKey======================================= */
enum class CPUCacheKey { AICPU_SYNC_BY_SW = 0, TSCPU_SYNC_BY_SW = 0, CPU_CACHE_KEY_END };

const std::vector<std::string> CPU_CACHE = {"AICPUSyncBySW", "TSCPUSyncBySW"};

/* =============================DSARandom======================================== */
enum class DSARandomKey { COUNTER_WORKSPACE_SIZE = 0, DSA_RANDOM_KEY_END };

const std::vector<std::string> DSA_RANDOM = {"CounterWorkspaceSize"};

/* ============================SoCInfo=========================================== */
enum class SocInfoKey { AI_CORE_CNT = 0, SOC_INFO_KEY_END };

const std::vector<std::string> SOC_INFO = {"ai_core_cnt"};

/* ============================SoftwareSpec======================================= */
enum class SoftwareSpecKey { JIT_COMPILE_DEFAULT_VALUE = 0, JIT_COMPILE_MODE, SOFTARE_SPEC_KEY_END };

const std::vector<std::string> SOFTWARE_SPEC = {"jit_compile_default_value", "jit_compile_mode"};

/* ============================VectorCoreMemoryRates==================================== */
enum class VectorCoreMemoryRatesKey { DDR_RATE = 0, VECTOR_CORE_MEMORY_RATES_KEY_END };

const std::vector<std::string> VECTOR_CORE_MEMORY_RATES = {"ddr_rate"};

/* ============================VectorCoreSpec====================================== */
enum class VectorCoreSpecKey { VEC_FREQ = 0, VECTOR_CORE_SPEC_KEY_END };

const std::vector<std::string> VECTOR_CORE_SPEC = {"vec_freq"};

/* ============================Version============================================== */
enum class VersionKey { VERSION_KEY_END };

const std::vector<std::string> VERSION = {};

/* ============================IntrinsicTypeKey================================== */
enum class IntrinsicTypeKey { MMAD = 0, INTRINSIC_TYPE_KEY_END };
