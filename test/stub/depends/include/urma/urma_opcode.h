...
typedef enum urma_jfc_state { URMA_JFC_STATE_INVALID = 0, URMA_JFC_STATE_VALID, URMA_JFC_STATE_ERROR } urma_jfc_state_t;
...
typedef enum urma_jfr_state { URMA_JFR_STATE_RESET = 0, URMA_JFR_STATE_READY, URMA_JFR_STATE_ERROR } urma_jfr_state_t;
