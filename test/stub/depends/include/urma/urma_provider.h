...
typedef struct urma_ops {
    ...
    urma_status_t (*advise_jfr_async)(
        urma_jfs_t* jfs, urma_target_jetty_t* tjfr, urma_advise_async_cb_func cb_fun, void* cb_arg);
    ...
    urma_status_t (*advise_jetty_async)(
        urma_jetty_t* jetty, urma_target_jetty_t* tjetty, urma_advise_async_cb_func cb_fun, void* cb_arg);
    ...
    int (*modify_tp)(
        urma_context_t* ctx, uint32_t tpn, urma_tp_cfg_t* cfg, urma_tp_attr_t* attr, urma_tp_attr_mask_t mask);
    /* Control plane OPs */
    urma_status_t (*get_tp_list)(
        urma_context_t* ctx, urma_get_tp_cfg_t* cfg, uint32_t* tp_cnt, urma_tp_info_t* tp_list);
    urma_status_t (*set_tp_attr)(
    ...
    urma_target_jetty_t* (*import_jetty_ex)(
        urma_context_t* ctx, urma_rjetty_t* rjetty, urma_token_t* token_value, urma_active_tp_cfg_t* active_tp_cfg);
    urma_target_jetty_t* (*import_jfr_ex)(
        urma_context_t* ctx, urma_rjfr_t* rjfr, urma_token_t* token_value, urma_active_tp_cfg_t* active_tp_cfg);
    urma_status_t (*bind_jetty_ex)(
        urma_jetty_t* jetty, urma_target_jetty_t* tjetty, urma_active_tp_cfg_t* active_tp_cfg);
    ...
    urma_target_seg_t* (*import_seg)(
        urma_context_t* ctx, urma_seg_t* seg, urma_token_t* token, uint64_t addr, urma_import_seg_flag_t flag);
    ...
    /* Jetty async OPs */
    urma_target_jetty_t* (*import_jetty_async)(
        urma_notifier_t* notifier, const urma_rjetty_t* rjetty, const urma_token_t* token_value, uint64_t user_ctx,
        int timeout);
    urma_status_t (*unimport_jetty_async)(urma_target_jetty_t* target_jetty);

    urma_status_t (*bind_jetty_async)(
        urma_notifier_t* notifier, urma_jetty_t* jetty, urma_target_jetty_t* tjetty, uint64_t user_ctx, int timeout);
...
int urma_cmd_import_jfr(
    urma_context_t* ctx, urma_target_jetty_t* tjfr, urma_tjfr_cfg_t* cfg, urma_cmd_udrv_priv_t* udata);
int urma_cmd_import_jfr_ex(
    urma_context_t* ctx, urma_target_jetty_t* tjfr, urma_tjfr_cfg_t* cfg, urma_import_jfr_ex_cfg_t* ex_cfg,
...
int urma_cmd_import_jetty(
    urma_context_t* ctx, urma_target_jetty_t* tjetty, urma_tjetty_cfg_t* cfg, urma_cmd_udrv_priv_t* udata);
int urma_cmd_import_jetty_ex(
    urma_context_t* ctx, urma_target_jetty_t* tjetty, urma_tjetty_cfg_t* cfg, urma_import_jetty_ex_cfg_t* ex_cfg,
    urma_cmd_udrv_priv_t* udata);
...
int urma_cmd_bind_jetty_ex(
    urma_jetty_t* jetty, urma_target_jetty_t* tjetty, urma_bind_jetty_ex_cfg_t* ex_cfg, urma_cmd_udrv_priv_t* udata);
int urma_cmd_unbind_jetty(urma_jetty_t* jetty);

int urma_cmd_create_jetty_grp(
    urma_context_t* ctx, urma_jetty_grp_t* jetty_grp, urma_jetty_grp_cfg_t* cfg, urma_cmd_udrv_priv_t* udata);
...
int urma_cmd_alloc_token_id_ex(
    urma_context_t* ctx, urma_token_id_t* token_id, urma_token_id_flag_t flag, urma_cmd_udrv_priv_t* udata);
int urma_cmd_free_token_id(urma_token_id_t* token_id);

int urma_cmd_register_seg(
    urma_context_t* ctx, urma_target_seg_t* tseg, urma_seg_cfg_t* cfg, urma_cmd_udrv_priv_t* udata);
int urma_cmd_unregister_seg(urma_target_seg_t* tseg);

int urma_cmd_import_seg(
    urma_context_t* ctx, urma_target_seg_t* tseg, urma_import_tseg_cfg_t* cfg, urma_cmd_udrv_priv_t* udata);
...
int urma_cmd_get_net_addr_list(
    urma_context_t* ctx, uint32_t max_netaddr_cnt, urma_net_addr_info_t* net_addr_info, uint32_t* cnt);
int urma_cmd_modify_tp(
    urma_context_t* ctx, uint32_t tpn, urma_tp_cfg_t* cfg, urma_tp_attr_t* attr, urma_tp_attr_mask_t mask);
...
int urma_cmd_import_jetty_async(
    urma_notifier_t* notifier, urma_target_jetty_t* tjetty, urma_tjetty_cfg_t* cfg, uint64_t user_ctx, int timeout,
    urma_cmd_udrv_priv_t* udata);
int urma_cmd_unimport_jetty_async(urma_target_jetty_t* tjetty);

int urma_cmd_bind_jetty_async(
    urma_notifier_t* notifier, urma_jetty_t* jetty, urma_target_jetty_t* tjetty, uint64_t user_ctx, int timeout,
    urma_cmd_udrv_priv_t* udata);
...
int urma_cmd_get_tp_list(
    urma_context_t* ctx, urma_get_tp_cfg_t* cfg, uint32_t* tp_cnt, urma_tp_info_t* tp_list,
    urma_cmd_udrv_priv_t* udata);
int urma_cmd_set_tp_attr(
    const urma_context_t* ctx, const uint64_t tp_handle, const uint8_t tp_attr_cnt, const uint32_t tp_attr_bitmap,
    const urma_tp_attr_value_t* tp_attr, urma_cmd_udrv_priv_t* udata);
int urma_cmd_get_tp_attr(
    const urma_context_t* ctx, const uint64_t tp_handle, uint8_t* tp_attr_cnt, uint32_t* tp_attr_bitmap,
    urma_tp_attr_value_t* tp_attr, urma_cmd_udrv_priv_t* udata);
int urma_cmd_exchange_tp_info(
    urma_context_t* ctx, urma_get_tp_cfg_t* cfg, uint64_t local_tp_handle, uint32_t tx_psn, uint64_t* peer_tp_handle,
    uint32_t* rx_psn);
