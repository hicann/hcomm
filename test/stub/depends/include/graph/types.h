...
inline int32_t GetFormatFromSub(int32_t primary_format, int32_t sub_format)
{
    return static_cast<int32_t>(
        (static_cast<uint32_t>(primary_format) & 0xffU)
...
{
    return static_cast<int32_t>(
        (static_cast<uint32_t>(format) & 0xffffffU) | ((static_cast<uint32_t>(c0_format) & 0xfU) << kBitThreeBytes));
}
...
inline bool HasC0Format(int32_t format) { return ((static_cast<uint32_t>(format) & 0xf000000U) >> kBitThreeBytes) > 0; }
...
struct TensorType {
    ...
    static TensorType ALL()
    {
        return TensorType{DT_BOOL,   DT_COMPLEX128, DT_COMPLEX64, DT_DOUBLE,   DT_FLOAT,    DT_FLOAT16,
                          ...
                          DT_UINT32, DT_UINT64,     DT_UINT8,     DT_BF16,     DT_COMPLEX32};
    }
    ...
    {
        return TensorType{DT_BOOL,   DT_COMPLEX128, DT_COMPLEX64, DT_DOUBLE,   DT_FLOAT,  DT_FLOAT16,
                          DT_INT16,  DT_INT32,      DT_INT64,     DT_INT8,     DT_UINT16, DT_UINT32,
