...
typedef enum { RT_DEV_RES_CUBE_CORE = 0, RT_DEV_RES_VECTOR_CORE, RT_DEV_RES_TYPE_MAX } rtDevResLimitType_t;
...
typedef enum rtFusionType { RT_FUSION_AICORE_CCU, RT_FUSION_AICORE_AICPU } rtFusionExType_t;
...
typedef enum rtUbExType { RT_UB_TYPE_DOORBELL, RT_UB_TYPE_DIRECT_WQE } rtUbExType_t;
