 ...
 * Description: ccu executor -- Store Executor
 * Author: caiyifan
 */
...
public:
    explicit StoreExecutor(int streamId, int rankId, int dieId, const hcomm::CcuRep::CcuInstr &instr, CcuSimulator *ccuSimulator)
