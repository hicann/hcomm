...
void JumpExecutor::RunV2() {
    ...
    switch (conditionType_) {
        case 0: // 等于
            ...
            HCCL_VM_INFO("When conditionX{}{} equal to expectData{}{}, Jump Mode{},Jump instruction offset{}{}",
                conditionXnId, conditionValue, expectedXnId, expectedValue, jumpMode_, relTarInstrXnId, relTarInstrValue);
            break;
        case 1: // 不等于
            updateNextInsIdx(conditionValue != expectedValue);
            HCCL_VM_INFO("When conditionX{}{} not equal to expectData{}{}, Jump Mode{}, Jump instruction offset{}{}",
                conditionXnId, conditionValue, expectedXnId, expectedValue, jumpMode_, relTarInstrXnId, relTarInstrValue);
            break;
        case 2: // 大于
            updateNextInsIdx(conditionValue > expectedValue);
            HCCL_VM_INFO("When conditionX{}{} greater than expectData{}{}, Jump Mode{}, Jump instruction offset{}{}",
                conditionXnId, conditionValue, expectedXnId, expectedValue, jumpMode_, relTarInstrXnId, relTarInstrValue);
            break;
        case 3: // 大于/等于
            updateNextInsIdx(conditionValue >= expectedValue);
            HCCL_VM_INFO("When conditionX{}{} greater than or equal to expectData{}{}, Jump Mode{}, Jump instruction offset{}{}",
                conditionXnId, conditionValue, expectedXnId, expectedValue, jumpMode_, relTarInstrXnId, relTarInstrValue);
            break;
        case 4: // 小于
            updateNextInsIdx(conditionValue < expectedValue);
            HCCL_VM_INFO("When conditionX{}{} less than expectData{}{}, Jump Mode{}, Jump instruction offset{}{}",
                conditionXnId, conditionValue, expectedXnId, expectedValue, jumpMode_, relTarInstrXnId, relTarInstrValue);
            break;
        case 5: // 小于/等于
            updateNextInsIdx(conditionValue <= expectedValue);
            HCCL_VM_INFO("When conditionX{}{} less than or equal to expectData{}{}, Jump Mode{}, Jump instruction offset{}{}",
                conditionXnId, conditionValue, expectedXnId, expectedValue, jumpMode_, relTarInstrXnId, relTarInstrValue);
            break;
        default: // 无条件跳转
            updateNextInsIdx(true);
            HCCL_VM_INFO("When conditionX{}{} is true, Jump Mode{}, Jump instruction offset{}{}",
...
CcuTrace::CcuInstrTraceDetail JumpExecutor::CollectTraceDetail()
{
    ...
    if (version_ == RunnerCcuVersion::CCU_V1) {
        ...
        detail.args["relTarInstrValue"] = std::to_string(ccuResMgr.GetXnValue(rankId_, dieId_, GetXnId(relTarInstrXnId_)));
    }
    return detail;
}
