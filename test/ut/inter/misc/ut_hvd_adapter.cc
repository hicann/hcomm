...
protected:
    static void SetUpTestCase() { std::cout << "\033[36m--HvdAdapterTest SetUP--\033[0m" << std::endl; }
    static void TearDownTestCase() { std::cout << "\033[36m--HvdAdapterTest TearDown--\033[0m" << std::endl; }
