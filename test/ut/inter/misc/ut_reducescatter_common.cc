...
protected:
    static void SetUpTestCase() { std::cout << "ReduceScatterCommonTest SetUP" << std::endl; }
    static void TearDownTestCase() { std::cout << "ReduceScatterCommonTest TearDown" << std::endl; }
