...
struct ibv_context_ops {
    ...
    int (*rereg_mr)(struct ibv_mr* mr, int flags, struct ibv_pd* pd, void* addr, size_t length, int access);
...
enum ibv_cq_init_attr_mask { IBV_CQ_INIT_ATTR_MASK_FLAGS = 1 << 0, IBV_CQ_INIT_ATTR_MASK_RESERVED = 1 << 1 };
...
struct verbs_context {
    ...
    struct ibv_cq* (*create_ext_cq)(
        struct ibv_context* context, int cqe, void* cq_context, struct ibv_comp_channel* channel, int comp_vector,
        int partid);
    void (*munmap_ai_notify)(struct ibv_context* context, void* vaddr, size_t length);
    int (*mmap_ai_notify)(
        struct ibv_context* context, unsigned long long* vaddr, size_t total_len, int type, int partid);
    int (*ext_post_send)(
    ...
    struct ibv_mr* (*reg_ai_mr)(struct ibv_pd* pd, void* addr, size_t length, int access, struct ibv_mr_ai_attr* attr);
    int (*destroy_ai_qp)(struct ibv_qp* qp);
    struct ibv_qp* (*create_ai_qp)(
        struct ibv_pd* pd, struct ibv_qp_init_attr* attr, struct ibv_qp_ai_attr* ai_attr,
...
#define verbs_get_ctx_op(ctx, op)                                                                                 \
    ({                                                                                                            \
        ...
        (!__vctx || (__vctx->sz < sizeof(*__vctx) - offsetof(struct verbs_context, op)) || !__vctx->op) ? NULL :  \
                                                                                                          __vctx; \
    })
 ...
 */
static inline struct ibv_cq_ex* ibv_create_cq_ex(struct ibv_context* context, struct ibv_cq_init_attr_ex* cqAttr)
{
...
ibv_create_srq_ex(struct ibv_context* context, struct ibv_srq_init_attr_ex* srq_init_attr_ex)
{
...
static inline struct ibv_qp* ibv_create_qp_ex(struct ibv_context* context, struct ibv_qp_init_attr_ex* qp_init_attr_ex)
{
    struct verbs_context* vctx;
...
ibv_alloc_parent_domain(struct ibv_context* context, struct ibv_parent_domain_init_attr* attr)
{
    struct verbs_context* vctx;
 ...
 */
static inline int ibv_query_device_ex(
    struct ibv_context* context, const struct ibv_query_device_ex_input* input, struct ibv_device_attr_ex* attr)
{
    struct verbs_context* vctx;
    int ret;
...
ibv_create_rwq_ind_table(struct ibv_context* context, struct ibv_rwq_ind_table_init_attr* init_attr)
{
    struct verbs_context* vctx;
 ...
 */
int ibv_init_ah_from_wc(
    struct ibv_context* context, uint8_t port_num, struct ibv_wc* wc, struct ibv_grh* grh, struct ibv_ah_attr* ah_attr);
...
int ibv_resolve_eth_l2_from_gid(
    struct ibv_context* context, struct ibv_ah_attr* attr, uint8_t eth_mac[ETHERNET_LL_SIZE], uint16_t* vid);
 ...
 */
static inline struct ibv_qp* ibv_create_ai_qp(
    struct ibv_pd* pd, struct ibv_qp_init_attr* qp_init_attr, struct ibv_qp_ai_attr* ai_attr,
    struct ibv_qp_ai_resp* ai_resp)
{
    struct verbs_context* vctx;
...
ibv_reg_ai_mr(struct ibv_pd* pd, void* addr, size_t length, int access, struct ibv_mr_ai_attr* ai_attr)
{
    struct verbs_context* vctx;
 ...
 */
static inline int
ibv_mmap_ai_notify(struct ibv_context* context, unsigned long long* vaddr, size_t total_len, int type, int partid)
{
    struct verbs_context* vctx;
...
static inline void ibv_munmap_ai_notify(struct ibv_context* context, void* vaddr, size_t length)
{
    struct verbs_context* vctx;
