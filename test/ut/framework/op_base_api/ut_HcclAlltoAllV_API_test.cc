...
{
    UT_SET_SENDBUFV_RECVBUFV(
        HCCL_COM_DATA_SIZE, 1, HCCL_COM_DATA_SIZE, 1, 0, HCCL_COM_DATA_SIZE, 1, HCCL_COM_DATA_SIZE, 1, 0);
    free(sendBuf);
    sendBuf = recvBuf;
    ...
    HcclResult ret = HcclAlltoAllVInner(
        sendBuf, sendCounts, sendDispls, HCCL_DATA_TYPE_INT8, recvBuf, recvCounts, recvDispls, HCCL_DATA_TYPE_INT8,
        comm, stream);
...
{
    UT_SET_SENDBUFV_RECVBUFV(0, 1, HCCL_COM_DATA_SIZE, 1, 0, HCCL_COM_DATA_SIZE, 1, HCCL_COM_DATA_SIZE, 1, 0);
    UT_COMM_CREATE_DEFAULT(comm);
    UT_STREAM_CREATE_DEFAULT(stream);
...
{
    UT_SET_SENDBUFV_RECVBUFV(HCCL_COM_DATA_SIZE, 0, 0, 1, 0, HCCL_COM_DATA_SIZE, 1, HCCL_COM_DATA_SIZE, 1, 0);
    UT_COMM_CREATE_DEFAULT(comm);
    UT_STREAM_CREATE_DEFAULT(stream);
...
{
    UT_SET_SENDBUFV_RECVBUFV(
        HCCL_COM_DATA_SIZE, 1, HCCL_COM_DATA_SIZE, 0, 0, HCCL_COM_DATA_SIZE, 1, HCCL_COM_DATA_SIZE, 1, 0);
    UT_COMM_CREATE_DEFAULT(comm);
    UT_STREAM_CREATE_DEFAULT(stream);
...
{
    UT_SET_SENDBUFV_RECVBUFV(HCCL_COM_DATA_SIZE, 1, 0, 1, 0, HCCL_COM_DATA_SIZE, 1, HCCL_COM_DATA_SIZE, 1, 0);
    UT_COMM_CREATE_DEFAULT(comm);
    UT_STREAM_CREATE_DEFAULT(stream);
...
{
    UT_SET_SENDBUFV_RECVBUFV(HCCL_COM_DATA_SIZE, 1, HCCL_COM_DATA_SIZE, 1, 0, 0, 1, HCCL_COM_DATA_SIZE, 1, 0);
    UT_COMM_CREATE_DEFAULT(comm);
    UT_STREAM_CREATE_DEFAULT(stream);
...
{
    UT_SET_SENDBUFV_RECVBUFV(HCCL_COM_DATA_SIZE, 1, HCCL_COM_DATA_SIZE, 1, 0, HCCL_COM_DATA_SIZE, 0, 0, 1, 0);
    UT_COMM_CREATE_DEFAULT(comm);
    UT_STREAM_CREATE_DEFAULT(stream);
...
{
    UT_SET_SENDBUFV_RECVBUFV(
        HCCL_COM_DATA_SIZE, 1, HCCL_COM_DATA_SIZE, 1, 0, HCCL_COM_DATA_SIZE, 1, HCCL_COM_DATA_SIZE, 0, 0);
    UT_COMM_CREATE_DEFAULT(comm);
    UT_STREAM_CREATE_DEFAULT(stream);
...
{
    UT_SET_SENDBUFV_RECVBUFV(HCCL_COM_DATA_SIZE, 1, HCCL_COM_DATA_SIZE, 1, 0, HCCL_COM_DATA_SIZE, 1, 0, 1, 0);
    UT_COMM_CREATE_DEFAULT(comm);
    UT_STREAM_CREATE_DEFAULT(stream);
...
{
    UT_SET_SENDBUFV_RECVBUFV(
        HCCL_COM_BIG_DATA_SIZE, 1, HCCL_COM_BIG_DATA_SIZE, 1, 0, HCCL_COM_BIG_DATA_SIZE, 1, HCCL_COM_BIG_DATA_SIZE, 1,
        0);
    UT_COMM_CREATE_DEFAULT(comm);
    UT_STREAM_CREATE_DEFAULT(stream);
...
{
    UT_SET_SENDBUFV_RECVBUFV(
        rankNum * HCCL_COM_DATA_SIZE, rankNum, HCCL_COM_DATA_SIZE, rankNum, HCCL_COM_DATA_SIZE,
        rankNum * HCCL_COM_DATA_SIZE, rankNum, HCCL_COM_DATA_SIZE, rankNum, HCCL_COM_DATA_SIZE);
    UT_COMM_CREATE_DEFAULT(comm);
    UT_STREAM_CREATE_DEFAULT(stream);
