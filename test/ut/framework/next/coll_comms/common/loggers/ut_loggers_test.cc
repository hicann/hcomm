...
TEST_F(ChannelLoggerTest, IsRoceProtocol_Roce)
{
    EXPECT_TRUE(ChannelLogger::IsRoceProtocol(descRoce));
}

TEST_F(ChannelLoggerTest, IsRoceProtocol_NonRoce)
{
    EXPECT_FALSE(ChannelLogger::IsRoceProtocol(desc));
}
...
{
    ChannelLogger::PrintErrorInfo(0, 0, desc, 0x12345678,
        static_cast<int32_t>(4), 100, Hccl::TlsStatus::ENABLE);
    SUCCEED();
}
...
{
    ChannelLogger::PrintErrorInfo(0, 0, desc, 0x12345678,
        static_cast<int32_t>(3), 50, Hccl::TlsStatus::DISABLE);
    SUCCEED();
}
...
{
    ChannelLogger::PrintErrorInfo(0, 0, desc, 0x12345678,
        static_cast<int32_t>(2), 200, Hccl::TlsStatus::UNKNOWN);
    SUCCEED();
}
