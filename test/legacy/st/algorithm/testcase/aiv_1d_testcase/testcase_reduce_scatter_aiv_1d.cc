...
protected:
    static void SetUpTestCase() { std::cout << "AivReduceScatterMesh1D set up." << std::endl; }

    static void TearDownTestCase() { std::cout << "AivReduceScatterMesh1D tear down" << std::endl; }
    ...
    void RunAivReduceScatterMesh1DTest(
