...
static std::vector<AivKernelInfo> g_aivKernelInfoList = {
    ...
    {"hccl_aiv_sync_cn", HcclCMDType::HCCL_CMD_INVALID, HcclDataType::HCCL_DATA_TYPE_RESERVED,
     KernelArgsType::ARGS_TYPE_SIMPLE},
};
...
HcclResult ExecuteKernelLaunchImpl(
    ...
    const AivAlgArgs& algArgs, AivProfilingInfo& aivProfilingInfo, KernelLaunchMode launchMode,
    void* extraArgsPtr = nullptr)
{
    // 如果输入为0，直接返回
