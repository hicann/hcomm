...
public:
    ...
    HcclResult Wait(
        Stream& stream, HcclDispatcher dispatcherPtr, s32 stage = INVALID_VALUE_STAGE,
        u32 timeOut = NOTIFY_DEFAULT_WAIT_TIME);
    HcclResult Post(Stream& stream, HcclDispatcher dispatcherPtr, s32 stage = INVALID_VALUE_STAGE);
