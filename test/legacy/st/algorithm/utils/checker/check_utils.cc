...
{
    return (
        opType == CheckerOpType::ALLTOALL || opType == CheckerOpType::ALLTOALLV || opType == CheckerOpType::ALLTOALLVC);
}

bool IsSendRecvType(CheckerOpType opType) { return opType == CheckerOpType::SEND || opType == CheckerOpType::RECEIVE; }
