...
protected:
    static void SetUpTestCase() { std::cout << "CntNto1NotifyLiteMgrTest SetUP" << std::endl; }

    static void TearDownTestCase() { std::cout << "CntNto1NotifyLiteMgrTest TearDown" << std::endl; }

    virtual void SetUp() { std::cout << "A Test case in CntNto1NotifyLiteMgrTest SetUP" << std::endl; }
