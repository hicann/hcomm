...
TEST_F(RankInfoDetectTest, St_SetupServer_When_Invalid_Ip_Expect_E_INTERNAL)
{
    // when
...
TEST_F(RankInfoDetectTest, St_SetupRankInfoDetectService_When_Setup_Fail_Expect_E_INTERNAL)
{
    // when
