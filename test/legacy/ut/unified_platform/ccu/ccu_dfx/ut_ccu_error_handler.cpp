...
TEST_F(CcuErrorHandlerTest, test_error_info_when_rep_type_is_loc_post_sem)
{
    ...
    MOCKER(CcuErrorHandler::GetCcuCKEValue).stubs().with(mockcpp::any(), mockcpp::any(), mockcpp::any()).will(returnValue(static_cast<u16>(0xabcd)));
...
TEST_F(CcuErrorHandlerTest, test_error_info_when_rep_type_is_rem_wait_sem)
{
    ...
    MOCKER(CcuErrorHandler::GetCcuCKEValue).stubs().with(mockcpp::any(), mockcpp::any(), eq(101)).will(returnValue(static_cast<u16>(0xabcd)));
...
TEST_F(CcuErrorHandlerTest, test_error_info_when_rep_type_is_rem_wait_group)
{
    ...
    MOCKER(CcuErrorHandler::GetCcuCKEValue).stubs().with(mockcpp::any(), mockcpp::any(), eq(100)).will(returnValue(static_cast<u16>(0xabcd)));
...
TEST_F(CcuErrorHandlerTest, test_gen_error_info_loop)
{
    ...
    uint16_t mask = 0x0010;  // mask
    MOCKER(CcuErrorHandler::GetCcuCKEValue).stubs().with(mockcpp::any(), mockcpp::any(), eq(0xa)).will(returnValue(static_cast<u16>(0xabcd)));
