...
protected:
    ...
    {
        std::cout << "UbTransportLiteImplWaitWithTimeoutTest tests tear down." << std::endl;
    }
    ...
    {
        std::cout << "A Test case in UbTransportLiteImplWaitWithTimeoutTest TearDown" << std::endl;
