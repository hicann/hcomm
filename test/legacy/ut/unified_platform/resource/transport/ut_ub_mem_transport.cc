...
TEST_F(UbMemTransportTest, UbMemTransport_GetSingleLocBufferUniqueId)
{
    ...
    std::copy_n(result.data() + sizeof(outAddr) + sizeof(outSize), sizeof(outTokenId),
               reinterpret_cast<char *>(&outTokenId));
    std::copy_n(result.data() + sizeof(outAddr) + sizeof(outSize) + sizeof(outTokenId), sizeof(outTokenValue),
