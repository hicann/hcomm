...
TEST_F(PhyTopoTest, Ut_AddTopoGraph_When_TopoNotNull_Expect_ReturnTopo)
{
...
TEST_F(PhyTopoTest, Ut_GetTopoGraph_When_TopoNotAdded_Expect_ReturnNullptr)
{
    EXPECT_EQ(phyTopo.GetTopoGraph(), nullptr);
}

TEST_F(PhyTopoTest, Ut_Clear_When_TopoAdded_Expect_ResetTopoAndInitFlag)
{
