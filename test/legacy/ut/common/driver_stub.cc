...
drvError_t halResAddrUnmap(unsigned int devId, struct res_addr_info* res_info) { return drvError_t::DRV_ERROR_NONE; }
...
drvError_t halHostUnregister(void* srcPtr, UINT32 devid) { return drvError_t::DRV_ERROR_NONE; }
