...
#define CCU_WHILE_IMPL(expr, uid)                                                                                      \
    for (::AscendC::ccu::CondExpr uid##_ce = (expr), *uid##_p = &uid##_ce; uid##_p != nullptr; uid##_p = nullptr)      \
        for (const char *uid##_dwLbl = _CcuDoWhileStackPopForWhile(), *uid##_sen = reinterpret_cast<const char*>(1);   \
             uid##_sen != nullptr; uid##_sen = nullptr)                                                                \
            for (int uid##_rc                                                                                          \
                 = (uid##_dwLbl != nullptr) ?                                                                          \
                       static_cast<int>(CCU_SUCCESS) :                                                                 \
                       (uid##_ce.isVarCompare ?                                                                        \
                            static_cast<int>(CcuWhileBeginVar(                                                         \
                                uid##_ce.var->handle, uid##_ce.rhsVar->handle, uid##_ce.cond, CCU_LABEL(uid))) :       \
                            static_cast<int>(                                                                          \
                                CcuWhileBegin(uid##_ce.var->handle, uid##_ce.imm, uid##_ce.cond, CCU_LABEL(uid)))),    \
                 uid##_done = 0;                                                                                       \
                 uid##_rc == static_cast<int>(CCU_SUCCESS) && !uid##_done;                                             \
                 uid##_done = 1,                                                                                       \
                 uid##_rc = (uid##_dwLbl != nullptr) ?                                                                 \
                                (uid##_ce.isVarCompare ?                                                               \
                                     static_cast<int>(CcuDoWhileEndVar(                                                \
                                         uid##_ce.var->handle, uid##_ce.rhsVar->handle, uid##_ce.cond, uid##_dwLbl)) : \
                                     static_cast<int>(CcuDoWhileEnd(                                                   \
...
#define CCU_IF_IMPL(expr, uid)                                                                                         \
    for (::AscendC::ccu::CondExpr uid##_ce = (expr), *uid##_p = &uid##_ce; uid##_p != nullptr; uid##_p = nullptr)      \
        for (int uid##_rc                                                                                              \
             = (uid##_ce.isVarCompare ?                                                                                \
                    static_cast<int>(                                                                                  \
                        CcuIfBeginVar(uid##_ce.var->handle, uid##_ce.rhsVar->handle, uid##_ce.cond, CCU_LABEL(uid))) : \
                    static_cast<int>(CcuIfBegin(uid##_ce.var->handle, uid##_ce.imm, uid##_ce.cond, CCU_LABEL(uid)))),  \
             uid##_done = (uid##_rc == static_cast<int>(CCU_SUCCESS) ? (_CcuIfStackPush(CCU_LABEL(uid)), 0) : 1);      \
