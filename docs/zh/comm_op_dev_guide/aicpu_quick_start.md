...
开发者可以点击[样例链接](https://gitcode.com/cann/hccl/tree/9.2.0-beta.2/examples/04_custom_ops_p2p)获取完整样例代码，该样例使用HCCL通信算子开发接口实现了基于AI CPU通信引擎的Send和Receive算子，主要实现流程如下所示：
