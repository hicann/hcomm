...
typedef enum {
    ...
    HCCL_COMM_CONFIG_OP_EXPANSION_MODE = 3,     /* 通信算子展开模式 */
    HCCL_COMM_CONFIG_SUPPORT_INIT_BY_ENV = 4,  /* 是否支持以环境变量配置为初始值 */
    HCCL_COMM_CONFIG_WORLD_RANKID = 5,  /* NSLB-DP场景下指定当前进程在AI框架中的全局rank ID，Ascend 950PR&950DT系列产品不涉及此场景 */
    HCCL_COMM_CONFIG_JOBID = 6,  /* NSLB-DP场景下指定当前分布式业务的唯一标识，由AI框架生成，Ascend 950PR&950DT系列产品不涉及此场景 */
    ...
    HCCL_COMM_CONFIG_RETRY = 10,  /* 通信重执行配置，Ascend 950PR&950DT系列产品暂不支持 */
    HCCL_COMM_CONFIG_BUFFER_NAME = 11,  /* 共享CCLBuffer名称，Ascend 950PR&950DT系列产品暂不支持 */
