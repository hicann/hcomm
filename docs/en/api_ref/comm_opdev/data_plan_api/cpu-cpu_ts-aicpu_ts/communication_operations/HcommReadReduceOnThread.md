...
<!-- md-trans-meta sourceCommit=5a8b6510ac6a3236129bf053dfba6e7b50e61bdc translatedAt=2026-08-14T10:27:23.206Z pushedAt=2026-08-18T09:08:01.017Z -->
...
Reads data from the specified memory on the channel, reads memory data of length count\*sizeof\(dataType\) from src, performs the reduceOp operation with the memory data of the same length pointed to by dst, and outputs the result to dst. The API caller is the node where dst resides.
...
// Reduce the local memory data and the remote memory data, and output the result to the local memory.
