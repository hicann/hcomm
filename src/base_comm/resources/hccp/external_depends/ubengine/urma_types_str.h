...
static const char * const g_urma_link_width_str[] = {[0] = "unknown",
...
static const char * const g_urma_device_feat_str[URMA_DEVICE_FEAT_NUM] = {"OUT_OF_ORDER", "JFC_PER_WR", "STRIDE_OP",
    "LOAD_STORE_OP", "NON_PIN", "PERSISTENCE_MEM", "JFC_INLINE", "SPRAY_ENABLE", "SELECTIVE_RETRANS"};
...
static const char * const g_urma_atomic_feat_str[URMA_ATOMIC_FEAT_NUM] = {
    "compare_and_swap", "swap", "fetch_and_add", "fetch_and_sub", "fetch_and_and", "fetch_and_or", "fetch_and_xor"};
...
static const char * const g_urma_congestion_ctrl_alg_str[] = {[URMA_TP_CC_NONE] = "NONE",
...
static const char * const g_urma_jfc_state[] = {
    [URMA_JFC_STATE_INVALID] = "INVALID", [URMA_JFC_STATE_VALID] = "VALID", [URMA_JFC_STATE_ERROR] = "ERROR"};
...
static const char * const g_urma_jetty_state[] = {[URMA_JETTY_STATE_RESET] = "RESET",
...
static const char * const g_urma_jfr_state[] = {
    [URMA_JFR_STATE_RESET] = "RESET", [URMA_JFR_STATE_READY] = "READY", [URMA_JFR_STATE_ERROR] = "ERROR"};
