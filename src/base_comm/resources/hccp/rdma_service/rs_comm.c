...
struct OpcodeInterfaceInfo gInterfaceInfoList[] = {
    ...
    {RA_RS_TYPICAL_CQ_CREATE, 1},
    {RA_RS_GET_LITE_CQ_ATTR, 1},
    {RA_RS_QP_CREATE_WITH_CQ_WITH_ATTRS, 1},
    {RA_RS_TYPICAL_CQ_DESTROY, 1},
