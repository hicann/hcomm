...
typedef struct tagBifrostCncoiPuberRootRankVTbl {
    uint16_t tupleValLen;
    uint8_t noDcTuple;
    uint8_t pad001[1];
    int32_t tupleCntMax;
    void *cookie;
    F_BIFROST_CNCOI_PUBER_ON_FILL_ROOT_RANK_UPDATE_DATA onFillUpdateData;
    F_BIFROST_CNCOI_PUBER_ON_ROOT_RANK_TABLE onSub;
    F_BIFROST_CNCOI_PUBER_ON_ROOT_RANK_TABLE onUnSub;
    F_BIFROST_CNCOI_PUBER_ON_GET_ROOT_RANK_TUPLE_VAL_STR onGetTupleValStr;
    F_BIFROST_CNCOI_PUBER_ROOT_RANK_GETTUPLE_FIRST getFirstTuple;
