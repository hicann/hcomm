...
CcuRepShL::CcuRepShL(CcuInsGeneratorBase* insGenPtr, const Variable &varD, const Variable &varN, const Variable &varM)
...
CcuRepShL::CcuRepShL(CcuInsGeneratorBase* insGenPtr, const Address &addrD, const Variable &varN, const Variable &varM)
