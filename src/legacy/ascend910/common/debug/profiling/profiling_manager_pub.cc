...
bool ProfilingManagerPub::GetAdditionInfoState() { return ProfilingManager::Instance().GetAdditionInfoState(); }

bool ProfilingManagerPub::GetTaskApiState() { return ProfilingManager::Instance().GetTaskApiState(); }
