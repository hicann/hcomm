...
inline void
PrintGroupErrorLog(const std::string& stageErrInfo, const std::string& groupRankContent, const std::string& tag)
{
    HCCL_ERROR(
...
private:
    ...
    HcclResult InsertOpCtxInfo(
        u32& streamID, u32& taskID, std::string& tag, AlgType& algType, u32& index, const void* descBuf,
        size_t descBufLen) const;
    ...
    static void PrintFftsCtxInfo(FFTSOpInfo& fftsOpInfo);
