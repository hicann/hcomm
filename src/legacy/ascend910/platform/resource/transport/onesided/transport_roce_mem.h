...
private:
    ...
    enum class SupportStatus { INIT = 0, SUPPORT = 1, NOT_SUPPORT = 2 };
    ...
    HcclResult
    CreateRdmaSignal(std::shared_ptr<LocalIpcNotify>& localNotify, MemMsg& rdmaSignalInfo, MemType notifyType);
    ...
    HcclResult TransportRdmaWithType(
