...
namespace hccl {
CollAllReduceFor310PDoublingDirectExecutor::CollAllReduceFor310PDoublingDirectExecutor(
    ...
    TransportMemType& inputType, TransportMemType& outputType)
{
    ...
    HCCL_INFO(
        "[CollAllReduceFor310PDoublingDirectExecutor][CalcTransportMemType]"
...
HcclResult CollAllReduceFor310PDoublingDirectExecutor::KernelRun(const OpParam& param, ExecMem& execMem)
{
    ...
    HCCL_CONFIG_INFO(
        HCCL_ALG, "[CollAllReduceFor310PDoublingDirectExecutor][KernelRun] userRank[%u] starts with isInlineReduce[%d]",
...
HcclResult CollAllReduceFor310PDoublingDirectExecutor::CalcLevel0CommInfo(
    TransportMemType inputType, TransportMemType outputType, std::vector<LevelNSubCommTransport>& opTransport)
{
    ...
    HCCL_INFO(
        "[CollAllReduceFor310PDoublingDirectExecutor][CalcLevel0CommInfo]tag[%s] Calc RingComm finish", tag_.c_str());
    return HCCL_SUCCESS;
}
