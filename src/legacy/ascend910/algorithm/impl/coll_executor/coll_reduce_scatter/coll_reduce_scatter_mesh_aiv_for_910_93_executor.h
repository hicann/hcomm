...
public:
    CollReduceScatterMeshAivFor91093Executor(
...
private:
    HcclResult CopyAivCommInfoToDevice(
        const CommPlane levelIndex, const u32 subLevelIndex, AlgResourceResponse& algResource) override;
    ...
    HcclResult CalNumBlocksDeter(u32& numBlocks, u32 rankSize, u64 dataSize, HcclCMDType cmdType) const;
