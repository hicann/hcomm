...
namespace hccl {
CollReduceScatterFastDoubleRingFor91093Executor::CollReduceScatterFastDoubleRingFor91093Executor(
...
HcclResult CollReduceScatterFastDoubleRingFor91093Executor::DoubleRingReduceScatter(
...
REGISTER_EXEC(
    "ReduceScatterFastDoubleRingFor91093Executor", ReduceScatterFastDoubleRingFor91093,
    CollReduceScatterFastDoubleRingFor91093Executor);
} // namespace hccl
