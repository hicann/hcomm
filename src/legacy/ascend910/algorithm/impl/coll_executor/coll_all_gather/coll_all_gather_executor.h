...
protected:
    ...
    HcclResult CalculateLevel1AllgatherSlice(
    ...
    HcclResult CalculateLevel2AllgatherSlice(
    ...
    HcclResult AllGatherLevel2(
        const std::string& tag, DeviceMem& inputMem, DeviceMem& outputMem, u64 count, HcclDataType dataType,
