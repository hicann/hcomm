...
using RegisterToHeartBeatCallBack = HcclResult (*)(
...
using SetRankPortInfoCallBack = HcclResult (*)(s32 deviceLogicID, bool isUseRankPort, std::vector<u32>& ranksPort);
#ifdef __cplusplus
extern "C" {
#endif // __cplusplus
