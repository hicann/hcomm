...
// scatter的入口函数
HcclResult
MultiRootScatterRing::RunAsync(const u32 rank, const u32 rankSize, const std::vector<std::shared_ptr<Transport>>& links)
{
...
HcclResult
MultiRootScatterRing::MidScatterChunk(u32 rank, u32 rankSize, u32 sliceIdx, const std::vector<Slice>& outputSlices)
{
    (void)outputSlices;
    HcclResult ret;
    DeviceMem dstMem;
...
HcclResult
MultiRootScatterRing::TailScatterChunk(u32 rank, u32 rankSize, u32 sliceIdx, const std::vector<Slice>& outputSlices)
{
    (void)outputSlices;
    HcclResult ret;
    DeviceMem dstMem;
