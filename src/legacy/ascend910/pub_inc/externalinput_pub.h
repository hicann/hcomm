...
constexpr u32 HCCL_MULTI_QP_THRESHOLD_DEFAULT
    = 512; // 单位kB, 当每个QP分担到的数据量小于512字节时，就不做多QP拆分payload
...
HcclResult SetMasterInfo(
    const std::string& masterIp, const std::string& masterPort, const std::string& masterDeviceId,
