...
struct OrderLaunchResMgr {
    ...
    bool IsCtxMatch(u64 currentContext) const { return context == currentContext && resValid; }
...
public:
    ...
    HcclResult AclgraphLaunchInOrderToOrderStream(
