...
HcclResult CheckDeviceNumValid(
    const std::vector<hccl::RankInfo_t>& rankList, u32 deviceNum, u32 serverNum, std::string version = "");
...
void SetRetryEnable(
    ...
    bool& retryEnable, bool isInterServerRetry = GetExternalInputInterServerRetryEnable(),
