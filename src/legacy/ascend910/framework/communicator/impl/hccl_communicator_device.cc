...
HcclResult HcclCommunicator::Init(HcclCommParams& params, const RankTable_t& rankTable) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::InitOneSidedService(const RankTable_t& rankTable) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::InitOneSidedServiceNetDevCtx(u32 remoteRankId) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::DeInitOneSidedServiceNetDevCtx() { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::GetOneSidedService(IHcclOneSidedService** service) { return HCCL_SUCCESS; }
...
bool HcclCommunicator::IsSupportSymmetricMemory(HcclCMDType opType, OpParam& opParam) { return false; }

bool HcclCommunicator::IsSupportZeroCopy(const OpParam& opParam) { return false; }
...
HcclResult HcclCommunicator::InitCommParams(HcclCommParams& params) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::CheckDataType(const HcclDataType dataType, bool needReduce) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::InitZeroCopyMemoryAgent() { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::DeinitZeroCopyMemoryAgent(bool inDestructor) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::DestroyRemoteOpBasedMem(const std::string& tag) { return HCCL_E_NOT_SUPPORT; }

bool HcclCommunicator::IsAtomicInit() { return false; }

bool HcclCommunicator::IsNeedNicInit() { return false; }

HcclResult HcclCommunicator::GetBandWidthPerNPU(u32 level, float& bandWidth) { return HCCL_E_NOT_SUPPORT; }

HcclResult HcclCommunicator::GetDeviceNumPerAggregation(u32& deviceNumPerAggregation) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::GetAlgType(AlgType& algType, HcclCMDType opType) { return HCCL_E_NOT_SUPPORT; }

HcclResult HcclCommunicator::GetCommParams(HcclCommParams& params) { return HCCL_E_NOT_SUPPORT; }

HcclResult HcclCommunicator::GetCommRankTable(RankTable_t& rankTable) { return HCCL_E_NOT_SUPPORT; }
...
bool HcclCommunicator::CompareWithServerId(const ServerInfo_t& left, const ServerInfo_t& right) { return false; }

bool HcclCommunicator::CompareWithNicName(const NetworkInfo_t& left, const NetworkInfo_t& right) { return false; }

bool HcclCommunicator::CompareWithUserRank(const RankInfo& left, const RankInfo& right) { return false; }

HcclResult HcclCommunicator::InitPreResource(const RankTable_t& rankTable) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::InitTcpMode(const RankTable_t& rankTable) const { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::GetAivTag(s32 tagNum, bool isCapture, s32& aivTag) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::CheckDeviceType(const DevType deviceType) const { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::CheckReductionOp(const HcclReduceOp op) const { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::CheckUserRank(const u32 userRank) const { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::CheckCount(const u64 count) const { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::GetGroupCommonData(WorldGroupInfo& groupCommonData) const { return HCCL_SUCCESS; }
...
DeviceMem HcclCommunicator::GetWorkspaceScracthMem(const std::string& tag, u64 allocMemSize) { return DeviceMem(); }

std::vector<Stream> HcclCommunicator::GetWorkspaceSubStreams(const std::string& tag, u32 num) { return {}; }
...
HcclResult HcclCommunicator::GetInCCLbuffer(void*& buffer, u64& size) { return HCCL_E_NOT_SUPPORT; }

HcclResult HcclCommunicator::GetOutCCLbuffer(void*& buffer, u64& size) { return HCCL_E_NOT_SUPPORT; }
...
HcclResult HcclCommunicator::InitCCLbuffer(u64 inCCLbufferSize, u64 outCCLbufferSize) { return HCCL_E_NOT_SUPPORT; }

u32 HcclCommunicator::GetLocalNicPort(NicType nicType) { return 0; }

HcclResult HcclCommunicator::InitNic(bool isMC2ReInit) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::RegisterToHeartBeat(u32 peerRankId, string& tag) { return HCCL_E_NOT_SUPPORT; }

void HcclCommunicator::UnRegisterToHeartBeat() {}

void HcclCommunicator::UnRegisterToCommConfiger() {}

HcclResult HcclCommunicator::SetGlobalWorkSpace(std::vector<void*>& globalWorkSpaceAddr) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::GetandClearOverFlowTasks(std::vector<HcclDumpInfo>& hcclDumpInfo) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::GetDeviceId(s32& deviceId) const { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::GetCqeError(HcclResult& result) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::GetOpInconsistentError(HcclResult& result) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::SupportDeterministicOptim(bool& isDeterministicOptim) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::GetHccsLinkNum(u32& numHccsLink) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::ExecOp(HcclCMDType opType, OpParam& opParam, bool isCustom) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::InitAndCheckAicpuOrderNotify(u8& orderLaunchMode) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::AllocAndGetStreamContextBuff(u32 streamId, u64& addr, u64& size) { return HCCL_SUCCESS; }

u32 HcclCommunicator::UpdateOpIndex(const OpParam& opParam) { return 0; }
...
HcclResult HcclCommunicator::BuildPairLinkCounter(const std::string& algName) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::BuildIsUsedRdmaRank(const std::string& algName) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::BuildNicList(const std::string& algName) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::BuildBridgeRank(const std::string& algName) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::BuildCommPlanRank(const std::string& algName) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::BuildServerAndsuperPodRank(const std::string& algName) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::BuildCommPlaneSubGroupRank(const std::string& algName) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::BuildHierarchicalAlgOption(u32* ahcConfInfo) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::CopyHostOpResToDeviceParam(const std::string& newTag) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::RegisterDfxInfo(
    const OpParam& param, AlgType algType, const std::vector<Stream>& slaveStreams, bool isAiv,
...
HcclResult HcclCommunicator::SetDevicePid(s32 devicePid) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::CreateWorkSpace(u64 size, DeviceMem& buffer) const { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::GetWorkSpace(u64* workSpaceSize, u64* workSpace) const { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::Mc2AiCpuStreamAllocAndGet(u32 streamMode, rtStream_t& aiCpuStream) { return HCCL_SUCCESS; }
...
HcclResult
AicpuInitOpTilingDataAicpuCache(const OpParam& opParam, const HcclCMDType& opType, struct OpTilingData* opTilingData)
{
    return HCCL_SUCCESS;
}
...
bool HcclCommunicator::GetCommResource(const std::string& tag, void** commContext) { return false; }

bool HcclCommunicator::GetCommResource(void*& commContext) { return false; }
...
HcclResult HcclCommunicator::CreateCommAndStreamRes(const std::string& tag, Stream& stream) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::GetComm(const std::string& tag, CommBase** comm) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::CreateDeviceCommContext(u64 size, DeviceMem& buffer) const { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::GetTopoDesc(HcclTopoDescs* topoDescs, uint32_t topoSize) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::SetAivModeConfig(const bool aivMode) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::SetAicpuUnfoldConfig(const bool aicpuUnfold) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::SetExecTimeOutConfig(const s32 execTimeOut) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::CheckExitWaitResumeState(bool& isChangedLink) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::UnsetMemoryRange(void* baseVirPtr) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::DeactivateCommMemory(void* virPtr) { return HCCL_SUCCESS; }
...
u8 HcclCommunicator::GetOrderLaunchMode(bool isCapture) { return 0; }
...
void HcclCommunicator::UnloadBinary(aclrtBinHandle& binHandle) { return; }
...
HcclResult HcclCommunicator::GetLocalCCLBuf(void** addr, uint64_t* size) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::GetRemoteCCLBuf(uint32_t remoteRank, void** addr, uint64_t* size) { return HCCL_SUCCESS; }
HcclResult HcclCommunicator::GetKFCWorkSpace(void** addr, uint64_t* size) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::SetGetAicpuCommState(std::function<bool()> getAicpuCommState) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::CommGetNetLayers(uint32_t** netLayers, uint32_t* netLayerNum) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::CommGetInstSizeByNetLayer(uint32_t netLayer, uint32_t* rankNum) { return HCCL_SUCCESS; }
HcclResult HcclCommunicator::CommGetInstTopoTypeByNetLayer(uint32_t netLayer, u32* topoType) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::GetNetLayers(uint32_t** netLayers, uint32_t* netLayerNum) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::GetInstSizeByNetLayer(uint32_t netLayer, uint32_t* rankNum) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::GetInstTopoTypeByNetLayer(uint32_t netLayer, CommTopo* topoType) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::GetRankGraph(GraphType type, void** graph, uint32_t* len) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::GetHeterogMode(HcclHeterogMode* mode) { return HCCL_SUCCESS; }
...
void HcclCommunicator::SetReleaseChannel(std::function<HcclResult()> releaseChannel) { return; }
...
HcclResult HcclCommunicator::DeregisterWindow(HcclCommSymWindow winHandle) { return HCCL_SUCCESS; }
