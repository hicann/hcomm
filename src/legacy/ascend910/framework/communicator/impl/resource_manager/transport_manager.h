...
public:
    TransportManager(
        ...
        NICDeployment nicDeployment, bool isHaveCpuRank, bool isUseRankPort, bool isUsedRdmaLevel0,
    ...
    HcclResult
    GetRemoteRankList(OpCommTransport& opTransportResponse, std::vector<u32>& rankList, TransportType transportType);
    HcclResult
    GetIncreRemoteRankList(OpCommTransport& opTransportReq, std::vector<u32>& rankList, TransportType transportType);
...
private:
    ...
    HcclResult
    MakeRemoteLinkInfo(const u32 remoteRank, bool isInterRdma, u32 socketsPerLink, HcclRankLinkInfo& remoteLinkInfo);
    ...
    HcclResult
    TransportInit(MachinePara& machinePara, std::shared_ptr<Transport>& link, bool useOneDoorbell, TransportType type);
    ...
    HcclResult createSubCommLinkThreads(
        ...
        const HcclCMDType& opType = HcclCMDType::HCCL_CMD_INVALID, bool isIndOp = false, bool isNpuDirectRoce = false);
    HcclResult waitSubCommLinkThreadsComplete(struct SubCommLinkPara& subCommLinkPara);
    HcclResult
    checkSubCommLinkThreadsStatus(const std::string& tag, struct SubCommLinkPara& subCommLinkPara, bool isBackup);
