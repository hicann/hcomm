...
private:
    ...
    struct AddressRange {
        AddressRange(void* startPtr, u64 length) : start(reinterpret_cast<u64>(startPtr)), end(start + length) {}
        AddressRange(u64 startPtr, u64 length) : start(startPtr), end(start + length) {}
