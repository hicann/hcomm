...
void AicpuKfcUtils::PrintMsg(const std::string& desc, const HcclMsg& msg, bool runFlag)
{
    ...
    if (ver != HcclTilingVersion::DEPRECATED_TILING_VERSION) {
        HCCL_LOG_BY_LEVEL(
            logLevel,
            "%s: Msg[version %u, commType %u, opType %u, sendBuffer %p, recvBuffer %p, "
            ...
            static_cast<u32>(msg.opType), msg.sendBuffer, msg.recvBuffer, msg.dataCnt, msg.strideCount,
            msg.addMsg.v1Msg.ccOpTilingData, msg.addMsg.v1Msg.valid, static_cast<u32>(msg.addMsg.v1Msg.hcclDataType),
            msg.addMsg.v1Msg.repeatCnt, static_cast<s32>(msg.addMsg.v1Msg.selfHandleID), msg.addMsg.v1Msg.seqNum,
        ...
        HCCL_LOG_BY_LEVEL(
            ...
            desc.c_str(), static_cast<u32>(msg.addMsg.v0Msg.version), static_cast<u32>(msg.commType.msgType),
            static_cast<u32>(msg.opType), msg.sendBuffer, msg.recvBuffer, msg.dataCnt, msg.strideCount,
            static_cast<u32>(msg.addMsg.v0Msg.hcclDataType), msg.addMsg.v0Msg.p2pSrcDestRankId, msg.addMsg.v0Msg.valid,
            msg.addMsg.v0Msg.repeatCnt, msg.addMsg.v0Msg.everyTurnRsp, msg.addMsg.v0Msg.everyTurnWait,
            msg.addMsg.v0Msg.commDepGroupID, msg.addMsg.v0Msg.commDepHandleID, msg.addMsg.v0Msg.selfHandleID,
