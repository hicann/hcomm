...
SocketStatus Socket::GetStatus(u32 timeout)
{
    ...
    TRY_CATCH_PROCESS_THROW(
        NetworkApiException, result = HrtRaBlockGetOneSocket(static_cast<u32>(role), param, timeout),
        "Socket::GetStatus failed", PrintErrorSocketInfo());
