...
class InsBatchSendRecvExecutor : public InsCollAlgBase {
public:
...
private:
    ...
    HcclResult ProcessSendDataSlice(
        ...
        LinkData& link) const;
    HcclResult ProcessRecvDataSlice(
        InsQuePtr& queue, SendRecvSlice& recvRemoteSlice, u32 remoteRank, uint64_t scratchBufferAddr,
        LinkData& link) const;
